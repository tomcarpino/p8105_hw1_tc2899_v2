...
When converting the logical, character, and factor variables ot numeric variables, only logical and factor function properly. The character variable did not convert to numeric. 
