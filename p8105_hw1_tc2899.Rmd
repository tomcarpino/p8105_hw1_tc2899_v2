...
```{r xy_scattter1}
ggplot(problem2, aes(x = problem2$x, y = problem2$y, color = problem2$y)) + geom_point()

ggsave("problem2.pdf")

ggplot(problem2, aes(x = problem2$x, y = numeric, color = numeric)) + geom_point()

ggplot(problem2, aes(x = problem2$x, y = factor, color = factor)) + geom_point()
```
